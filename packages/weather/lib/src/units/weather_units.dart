/// Conversions d'unités vers les unités canoniques de FishMap AI.
///
/// Unités canoniques : vitesse en km/h, hauteur en mètres, période en
...
/// afin que [WeatherData] reste toujours normalisé.
class WeatherUnits {
