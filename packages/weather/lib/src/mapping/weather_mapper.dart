...
///
/// C'est le pont `WeatherData` → `WeatherMapper` → `FishScoreInput`. Le mapper
/// ne connaît aucun fournisseur : il travaille uniquement sur le modèle
/// normalisé, ce qui garde le moteur FishScore découplé de la source météo.
class WeatherMapper {
  const WeatherMapper();
